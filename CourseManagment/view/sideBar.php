                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                       ...
                       <?php if($_SESSION['user']['role']==="admin"){ ?> 
                        <li>
                            <a title="Landing Page" href="./all-events.php" aria-expanded="false"><span
                        ...
                        <li>
                            ...
                            <?php if($_SESSION['role']==="admin"){ ?>
                                <li><a title="All Students" href="./../../usemanagment/view/all-users.php"><span class="mini-sub-pro">All
                                            Students</span></a></li>
                                            <?php } ?>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                            <?php if($_SESSION['role']==="admin"){ ?>
                                <li><a title="All Students" href="./all-games.php"><span class="mini-sub-pro">All Games</span></a></li>
                                            <?php } ?>
                            </ul>
                        </li>
