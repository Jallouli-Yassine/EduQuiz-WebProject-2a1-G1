...
<head>
	...
	<!-- VENDOR CSS -->
	<link rel="stylesheet" href="./../../backEqTemplate/assets/vendor/bootstrap/css/bootstrap.min.css">
	<link rel="stylesheet" href="./../../backEqTemplate/assets/vendor/font-awesome/css/font-awesome.min.css">
	<link rel="stylesheet" href="./../../backEqTemplate/assets/vendor/linearicons/style.css">
	<!-- MAIN CSS -->
	<link rel="stylesheet" href="./../../backEqTemplate/assets/css/main.css">
	<!-- FOR DEMO PURPOSES ONLY. You should remove this in your project -->
	<link rel="stylesheet" href="./../../backEqTemplate/assets/css/demo.css">
	<!-- GOOGLE FONTS -->
	<link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700" rel="stylesheet">
	<!-- ICONS -->
	<link rel="apple-touch-icon" sizes="76x76" href="./../../backEqTemplate/assets/img/apple-icon.png">
	<link rel="icon" type="image/png" sizes="96x96" href="./../../backEqTemplate/assets/img/favicon.png">
</head>
...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div style="padding: 1% 5% 1% 1%;" class="brand">
				<a href="index.html"><img style="width :60px;" src="./../../img/EduQuiz.png" alt="Klorofil Logo"
		...
		<!-- END NAVBAR -->
		<!-- LEFT SIDEBAR -->
		<div style="padding-top: 8%;" id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li>
							<a href="#subPages" data-toggle="collapse" class="collapsed"><i
									class="lnr lnr-file-empty"></i> <span>Courses Managment</span> <i
									class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="myCourse.php" class="">my courses</a></li>
									<li><a href="add_course.php" class="">add course</a></li>

								</ul>
							</div>
						</li>
						<li>
							<a href="#userMan" data-toggle="collapse" class="collapsed"><i
									class="lnr lnr-file-empty"></i> <span>user managment</span> <i
									class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="userMan" class="collapse ">
								<ul class="nav">
						...
						<li>
							<a href="#profMan" data-toggle="collapse" class="collapsed"><i
									class="lnr lnr-file-empty"></i> <span>prof managment</span> <i
									class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="profMan" class="collapse ">
								<ul class="nav">
									<li><a href="page-profile.html" class="">Profile</a></li>
									<li><a href="page-login.html" class="">Login</a></li>
									<li><a href="page-lockscreen.html" class="">Lockscreen</a></li>
						...
						<li><a href="tables.php" class="active"><i class="lnr lnr-dice"></i> <span>Tables</span></a>
						</li>
	...
	<!-- END WRAPPER -->
	<!-- Javascript -->
	<script src="./../../backEqtemplate/assets/vendor/jquery/jquery.min.js"></script>
	<script src="./../../backEqtemplate/assets/vendor/bootstrap/js/bootstrap.min.js"></script>
	<script src="./../../backEqtemplate/assets/vendor/jquery-slimscroll/jquery.slimscroll.min.js"></script>
	<script src="./../../backEqtemplate/assets/scripts/klorofil-common.js"></script>
</body>
