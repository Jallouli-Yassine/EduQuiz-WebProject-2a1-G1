            ...
            <div class="container-fluid">
                ...
                <?php
                     if (isset($_POST['courseIDD'])){
                        $course = $courseC->getOneCourse($_POST['courseIDD']);
	             ?>
                                                            <form class="form-contact contact_form" action="./../controllers/mail.php"
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="form-outline">
                                                                                <textarea name="Description"
                                                                                    ...
                                                                                    onfocus="this.placeholder = 'Enter The EMAIL'"
                                                                                    onblur="this.placeholder = 'Enter The EMAIL'"
                                                                                    placeholder='Enter The EMAIL'></textarea>
