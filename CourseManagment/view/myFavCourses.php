...
session_start(); 
    ...
    $courseC = new CourseC();
    $listeCourse=$courseC->afficherFavCourses($_SESSION['user']['ID']);

    //print_r($coursessID);
    //$course=$courseC->getOneCourse($coursessID);
...
<?php foreach ($listeCourse as $course) {  
     ...
     //$myFavCourse=$courseC->getone($course['course_id']);
    ?>
    <?php 
      $FavCourse=$courseC->getOneCourse($course['course_id']);
    ...
    ?>
               <div style="height:100px" class="col-lg-4 course <?php echo $course['categorie']?>">
                    <div style="margin-bottom: 5%; height: 650px !important;" class="single_special_cource">
                        ...
                        <div class="special_cource_text">
                                ...
                                <div class="col-8">
                                    <form action="./course-details.php" method="post">
                                        <button href="course-details.php" class="btn_4">
                                            <?php echo $FavCourse['categorie'] ?>
                                        </button>
                                        <input type="hidden" value="<?php echo $FavCourse['courseID'] ?>" name="courseID"
                                            id="">
                                        <input type="hidden" value="<?php echo $FavCourse['vidExt'] ?>" name="vidExt"
                                            id="">
                                    </form>
                                </div>
                            ...
                            <a href="./../../course-details.php">
                                <h3>
                                    <?php echo $FavCourse['title'] ?>
                                </h3>
                            </a>
                            
                            <p>
                                
                                <?php echo $FavCourse['Descrip'] ?>
                  ...
                  <form action="./addCourseToFav.php" method="post">
                            <input type="hidden" value="<?php // echo $FavCourse['courseID'] ?>" name="courseID"
                                            id="">
                            <input style="border-radius:20%;margin-left:50%" class="btn btn-outline-danger" type="submit" value="add to fav" href="">
                            </form>
                          
                            -->
                            <form action="./removeCourseFromFav.php" method="post">
                                   <input type="" value="<?php echo $FavCourse['courseID'] ?>" name="courseID" id="">
