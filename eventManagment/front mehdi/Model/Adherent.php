<?php
  class Adherent
  {
    private string $idevent;
      ...
      private  $lienJeu;
    public function __construct ( string $nameevent,string $email,string $subject,string $date,string $time, $numberparticipate,string $image ,$lienJeu)
    {
  ...
  function getlienJeu(){return $this->lienJeu;}
