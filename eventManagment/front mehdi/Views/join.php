                 ...
                 <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                            <form  action="join2.php" method="POST" id="myform">  
                              ...
                              <input disabled value="<?php echo $_SESSION['user']['email'] ?>" class="form-control" name="email" id="name" onkeyup="format(this)" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your mail'" placeholder = 'mail'>
                              ...
                              <input type="hidden" value="<?php echo $_SESSION['user']['email'] ?>" class="form-control" name="email2" id="name" onkeyup="format(this)" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your mail'" placeholder = 'mail'>
                              <input type="hidden" value=<?php echo $_POST['idevent'] ;?> name='idevent'>  
                                <input type="hidden" value=<?php echo $_POST['nameevent'] ;?> name='nameevent'>  
                                ...
                                <input type="hidden" value=<?php echo $_POST['numberparticipate']-1;?> name='numberparticipate'>
                                <input type="hidden" value=<?php echo $_POST['image'] ;?> name='image'>  
                                <input type="hidden" value=<?php echo $_POST['lienJeu'] ;?> name='lienJeu'>  
                        <div class="form-group mt-3">

                          <button type="submit"  class="button button-contactForm btn_1">Join</button></form>
                        </div>
