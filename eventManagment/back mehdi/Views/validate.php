...
<head>
    ...
    <title>Event | EduQuiz - EduQuiz Admin Template</title>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo" src="../img/logo/1.png" alt="" width ="100" height="100"/></a>
                <strong><a href="index.html"><img src="../img/logo/2.png" alt="" /></a></strong>
            </div>
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                         ...
                         <ul class="submenu-angle" aria-expanded="true">
                             <li class="active"><a title="Calendar" href="../events.html"><span class="mini-sub-pro"aria-hidden="true"> Calendar</span></a></li>
                             <li class="active"><a title="Validate" href="validate.html"><span class="mini-sub-pro"aria-hidden="true"> Validate request</span></a></li>
                             
                         </ul>
                        </li>
                       <!-- <li class="active">
                            <a title="Landing Page" href="events.html" aria-expanded="true"><span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Event</span></a>
                        </li>-->
                        <li>
                                      ...
                                      <div class="row">
                                          <div class="col-md-12">
                                              <div class="table-wrap">
                                                 ...
                                                 <td> <img src="../<?php echo $Adherent['image']; ?>" width ="10" height="auto"></td>
                                                 <th>
                                                  ...
                                                  <th>
                                                    <th><a href="SupprimerAdherent.php? Idevent=<?php echo $Adherent ['idevent']; ?>">refuse</a></th>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>List Of Event <a href="">EduQuiz</a></p>
                        </div>
                    </div>
                </div>
            </div>
                                              ...
                                              <div class="table-wrap">
                                                  <table class="table table-dark">
                                                                        ...
                                                                        <tbody>
                                                                            <tr class="bg-primary">
                                                                            <?php
                                                                            foreach($ListeAdherents2 as $Adherent){
                                                                           ...
                                                                           <th>       </th>
                                                                           <th>       </th>
                                                                            <th><?php echo $Adherent['idevent']; ?> </th>
                                                                        <th><?php echo $Adherent['nameevent']; ?> </th>
                                                                        <th><?php echo $Adherent['email']; ?> </th>
                                                                        <th><?php echo $Adherent['subject']; ?> </th>
                                                                        <th><?php echo $Adherent['date']; ?> </th>
                                                                        <th><?php echo $Adherent['time']; ?> </th>
                                                                        <th><?php echo $Adherent['numberparticipate']; ?> </th>
                                                                        <th> <img src="../<?php echo $Adherent['image']; ?>" width ="10" height="auto"></th>
                                                                        <th></th>
                                                                            <th></th>
                                                                            <th></th>
                                                                        <tr>
