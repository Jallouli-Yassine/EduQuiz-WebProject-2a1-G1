...
include '../Config.php';
include 'C:/xampp/htdocs/EduQuiz-WebProject-2a1-G1/eventManagment/back%20mehdi/Model/Adherent.php';
...
class AdherentC 
 {
  ...
  {
    $sql="INSERT INTO event2 (nameevent,email,subject,date,time,numberparticipate,image,lienJeu) values (:nameevent,:email,:subject,:date,:time,:numberparticipate,:image,:lienJeu)";
    $db=config::getConnexion();
    $req=$db->prepare($sql);
