...
<body>
 ...
 <br>
                     ...
                     <input class="btn btn-primary border-success align-items-center btn-success" name="idC"  type="hidden" value="<?php echo $_POST['courseID'] ?>">
                      ...
                      <input class="btn btn-primary border-success align-items-center btn-success" name="scoreWon"  type="" value=0>
                      <input class="btn btn-primary border-success align-items-center btn-success"   id="reponseChoisie" class="reponseChoisie" max='4' min='1' name="reponseChoisie" type="hidden">
