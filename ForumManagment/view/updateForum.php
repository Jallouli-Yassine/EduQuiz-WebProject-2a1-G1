                ...
                <form class="form-contact contact_form" action="post.php?id=<?php echo $post['idpost'] ?>" method="POST" id="contactForm" novalidate="novalidate">
                    <div class="row">
                            ...
                            <div class="form-group">
                                <div class="form-outline">
                                    <input class="form-control" name="title" id="title" type="text"
                                        ...
                                        placeholder='Enter The Title' value="<?php echo $post['title']; ?>"  >
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <div class="form-outline">
                                    <input type="text" name="content" class="form-control" id="content" rows="4" value="<?php echo $post['content']; ?>" ></textarea>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <button type="submit" class="add_course button button-contactForm btn_1" value ="modifier " >update post</button>
