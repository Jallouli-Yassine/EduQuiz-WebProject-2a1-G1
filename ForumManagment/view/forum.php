...
<body>
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a style="width: 135px;" class="navbar-brand logo_1" href="index.html"> <img src="img/EduQuizWhite.png" alt="logo"> </a>
                        <a style="width: 135px;" class="navbar-brand logo_2" href="index.html"> <img src="img/EduQuiz.png" alt="logo"> </a>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <a href="tips-forum.html"> <span class="single_feature_icon"><i class="ti-light-bulb"></i></span> </a>
                            <p><b>Tips & Tricks</b></p><br>
                            <p>A place where you can share and ask for advice</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <a href="problem-forum.html"> <span class="single_service_icon style_icon"><i class="ti-pencil-alt"></i></span> </a>
                            <p><b>Problems & Solutions</b></p><br>
                            <p>A place where you can post questions and provide answers</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <a href="document-forum.html"> <span class="single_feature_icon"><i class="ti-new-window"></i></span> </a>
                            <p><b>Documents & Resources</b></p><br>
                            <p>A place where you recommand and ask for documents</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part single_feature_part_2">
                            <a href="random-forum.html"> <span class="single_feature_icon"><i class="ti-layers"></i></span> </a>
                            <p><b>Random Questions</b></p><br>
                            <p> A place where you can drop questions in all different topics</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!--div class="border border-light p-2 mb-3">
                    <div class="d-flex align-items-start">
                        <img class="me-2 avatar-sm rounded-circle" src="https://bootdey.com/img/Content/avatar/avatar4.png" alt="Generic placeholder image" width="30" height="30">
                        <div class="w-100">
                            <h5 class=""> Thelma Fridley <small class="text-muted"> 1 hour ago</small></h5>
                            <div class="">
                                Hello everyone, Hope you're doing well .<br> So I faced a problem resolving this quizz and I'd like you to help me finding a solution. Thank you in advance xoxo.
                                <br>
                    ...
                    <div class="post-user-comment-box">
                        <div class="d-flex align-items-start">
                            <img class="me-2 avatar-sm rounded-circle" src="https://bootdey.com/img/Content/avatar/avatar3.png" alt="Generic placeholder image" width="30" height="30">
                            <div class="w-100">
                                <h5 class="mt-0">Jeremy Tomlinson <small class="text-muted">3 hours ago</small></h5>
                                I guess i can help with that problem !
                                ...
                                <div class="d-flex align-items-start mt-3">
                                    <a class="pe-2" href="#">
                                        <img src="https://bootdey.com/img/Content/avatar/avatar4.png" class="avatar-sm rounded-circle" alt="Generic placeholder image" width="30" height="30">
                                    </a>
                                    <div class="w-100">
            ...
            <div class="row justify-content-between">
                <div class="col-sm-6 col-md-4 col-xl-3">
                    <div class="single-footer-widget footer_1">
                        <a href="index.html"> <img src="img/EduQuiz.png" alt=""> </a>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <p class="footer-text m-0">
                                    ...
                                    </script> All rights reserved | This template is made with <i class="ti-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>.Downloaded from <a href="https://themeslab.org/"
